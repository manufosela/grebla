...
describe('engineer-space: pestañas por tipo de persona', () => {
  it('un externo solo ve datos + o2o', () => {
    expect(visibleTabsFor({ external: true })).toEqual(['datos', 'o2o']);
  });

  it('un interno ve carrera/rolemirror/mapa/o2o', () => {
    expect(visibleTabsFor({ external: false })).toEqual(['carrera', 'rolemirror', 'mapa', 'o2o']);
    expect(visibleTabsFor({})).toEqual(['carrera', 'rolemirror', 'mapa', 'o2o']);
    expect(visibleTabsFor(null)).toEqual(['carrera', 'rolemirror', 'mapa', 'o2o']);
  });
