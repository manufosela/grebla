...
export class MetricsInterpretation extends LitElement {
  ...
  static styles = css`
    ...
    h5 { font-size: 0.78rem; text-transform: uppercase; letter-spacing: 0.03em; color: var(--rm-muted, #5b6b7d); margin: 0.6rem 0 0.25rem; }
    ul { margin: 0; padding-left: 1.1rem; font-size: 0.88rem; color: var(--rm-text, #111827); }
    li { margin: 0.15rem 0; }
    .dis { font-size: 0.72rem; color: var(--rm-muted, #5b6b7d); margin: 0.7rem 0 0; }
    .meta { font-size: 0.72rem; color: var(--rm-muted, #5b6b7d); font-style: italic; margin: 0.3rem 0 0; }
  `;
