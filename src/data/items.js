...
export const ITEMS = [
  // ── Gates de ramificación ────────────────────────────────────────────────
  {
    ...
    dimension: 'people',
    type: 'checkbox',
    weights: { engineer: 0, techLead: 0, em: 2, hoe: 2, vp: 2, cto: 1 },
  },
  {
    ...
    dimension: 'people',
    type: 'checkbox',
    weights: { engineer: 0, techLead: 0, em: 0, hoe: 2, vp: 2, cto: 1 },
  ...
  },
  {
    ...
    dimension: 'org',
    type: 'checkbox',
    weights: { engineer: 0, techLead: 1, em: 1, hoe: 2, vp: 2, cto: 2 },
  },
  {
    ...
    dimension: 'strategy',
    type: 'checkbox',
    weights: { engineer: 0, techLead: 0, em: 1, hoe: 2, vp: 2, cto: 2 },
  },
  ...
  },
  {
    ...
    dimension: 'strategy',
    type: 'scale',
    weights: { engineer: 0, techLead: 1, em: 0, hoe: 1, vp: 1, cto: 2 },
  ...
  },
  {
    ...
    dimension: 'strategy',
    type: 'scale',
    weights: { engineer: 0, techLead: 0, em: 0, hoe: 2, vp: 2, cto: 2 },
    visibleWhen: (a) => isChecked(a, GATES.ORG_STRATEGY),
  },
  ...
  // ── Personas y equipo (gated por MANAGES_PEOPLE) ─────────────────────────
  {
    ...
    dimension: 'people',
    type: 'scale',
    weights: { engineer: 0, techLead: 1, em: 2, hoe: 2, vp: 1, cto: 0 },
    visibleWhen: (a) => isChecked(a, GATES.MANAGES_PEOPLE),
  },
  {
  ...
  },
  {
    ...
    dimension: 'people',
    type: 'scale',
    weights: { engineer: 0, techLead: 1, em: 2, hoe: 2, vp: 2, cto: 1 },
    visibleWhen: (a) => isChecked(a, GATES.MANAGES_PEOPLE),
  },
  {
  ...
  // Rama IC: si NO gestiona personas, aparece mentoring horizontal
  {
    ...
    dimension: 'people',
    type: 'scale',
    weights: { engineer: 1, techLead: 2, em: 1, hoe: 0, vp: 0, cto: 0 },
    visibleWhen: (a) => !isChecked(a, GATES.MANAGES_PEOPLE),
  },
  ...
  // ── Procesos y delivery ──────────────────────────────────────────────────
  {
    ...
    dimension: 'delivery',
    type: 'scale',
    weights: { engineer: 1, techLead: 2, em: 2, hoe: 1, vp: 1, cto: 0 },
  },
  {
    ...
    dimension: 'delivery',
    type: 'scale',
    weights: { engineer: 0, techLead: 2, em: 2, hoe: 2, vp: 1, cto: 0 },
  },
  {
    id: 'delivery_metrics',
    ...
    dimension: 'delivery',
    type: 'scale',
    weights: { engineer: 0, techLead: 1, em: 1, hoe: 2, vp: 2, cto: 1 },
  ...
  },
  {
    ...
    dimension: 'org',
    type: 'scale',
    weights: { engineer: 0, techLead: 0, em: 1, hoe: 1, vp: 2, cto: 2 },
  ...
  // ── Técnico ──────────────────────────────────────────────────────────────
  {
    ...
    dimension: 'technical',
    type: 'scale',
    weights: { engineer: 2, techLead: 2, em: 1, hoe: 0, vp: 0, cto: 1 },
  },
  {
    ...
    dimension: 'technical',
    type: 'scale',
    weights: { engineer: 1, techLead: 2, em: 1, hoe: 1, vp: 0, cto: 1 },
  },
  {
    ...
    dimension: 'technical',
    type: 'scale',
    weights: { engineer: 1, techLead: 2, em: 0, hoe: 0, vp: 0, cto: 1 },
    visibleWhen: (a) => !isChecked(a, GATES.MANAGES_PEOPLE),
  },
  ...
  // ── Arquitectura ─────────────────────────────────────────────────────────
  {
    ...
    type: 'scale',
    weights: { engineer: 1, techLead: 2, em: 1, hoe: 1, vp: 0, cto: 2 },
  },
  {
    ...
    weights: { engineer: 1, techLead: 1, em: 0, hoe: 1, vp: 0, cto: 2 },
  },
  {
  ...
  // ── Producto y negocio ───────────────────────────────────────────────────
  {
    ...
    dimension: 'product',
    type: 'scale',
    weights: { engineer: 1, techLead: 1, em: 2, hoe: 2, vp: 2, cto: 2 },
  },
  {
  ...
  },
  {
    ...
    dimension: 'product',
    type: 'scale',
    weights: { engineer: 0, techLead: 0, em: 0, hoe: 1, vp: 1, cto: 2 },
    visibleWhen: (a) => isChecked(a, GATES.ORG_STRATEGY),
  },
  ...
  // ── Crecimiento propio (transversal, siempre visible) ────────────────────
  {
    ...
    dimension: 'growth',
    type: 'scale',
    weights: { engineer: 2, techLead: 1, em: 1, hoe: 1, vp: 1, cto: 1 },
  },
  {
    id: 'growth_feedback',
  ...
  },
  {
    ...
    weights: { engineer: 1, techLead: 1, em: 1, hoe: 1, vp: 1, cto: 1 },
  },
];
