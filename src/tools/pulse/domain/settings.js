 ...
 *
 * El 3 no es una preferencia: es la promesa de Marea. Por eso el umbral solo
 * SUBE. Un equipo grande puede querer 5 —con 3 personas en un gremio de treinta,
 * quien las conoce ata cabos—, pero nadie puede bajarlo a 2 y convertir el
 * agregado en un señalamiento. El suelo se valida aquí y se vuelve a validar en
 * el servidor: un formulario no protege nada.
 */
